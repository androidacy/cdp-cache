#+HTML: <a href="https://github.com/androidacy/cdp-cache/actions?query=workflow%3ACI"><img src="https://github.com/androidacy/cdp-cache/workflows/CI/badge.svg?branch=master" /></a>
#+HTML: </div>

#+HTML: <a href="https://www.codacy.com/manual/androidacy/cdp-cache?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=androidacy/cdp-cache&amp;utm_campaign=Badge_Grade"><img src="https://app.codacy.com/project/badge/Grade/43d801ba437a42419e479492eca72ee2" /></a>
#+HTML: </div>


#+HTML: <a href="https://goreportcard.com/report/github.com/androidacy/cdp-cache"><img src="https://goreportcard.com/badge/github.com/androidacy/cdp-cache" /></a>
#+HTML: </div>

#+HTML: <a href="https://codeclimate.com/github/androidacy/cdp-cache/test_coverage"><img src="https://api.codeclimate.com/v1/badges/a99b4ae948836cdedd12/test_coverage" /></a>
...
* How to build
  ...
  #+begin_src sh
    xcaddy build v2.0.0 --with github.com/androidacy/cdp-cache 
  #+end_src
...
* How to run
  ...
  #+begin_src sh
    docker run -it -p80:80 -p443:443 -v [the path of caddyfile]:/app/Caddyfile docker.pkg.github.com/androidacy/cdp-cache/caddy:latest
  #+end_src
